...
CREATE TABLE channels(
    pk_id_channel VARCHAR(24) PRIMARY KEY NOT NULL,
...
CREATE TABLE messages(
	pk_msg_id VARCHAR(24) PRIMARY KEY NOT NULL,	-- L'identifiant du message.
	s_author_id VARCHAR(24) NOT NULL,	-- L'identifiant de l'auteur du message
	s_channel_id VARCHAR(24) NOT NULL,	-- L'identifiant du salon pour fetch le message.
...
CREATE TABLE users(
    pk_user_id VARCHAR(24) PRIMARY KEY NOT NULL,
...
CREATE TABLE roles_levels(
	pk_role_id VARCHAR(24) PRIMARY KEY NOT NULL,
	s_guild_id VARCHAR(24) NOT NULL,
	n_niveau_requis INTEGER NOT NULL
);


DROP USER IF EXISTS 'franceBot'@'localhost';
CREATE USER 'franceBot'@'localhost' IDENTIFIED BY 'N0XlWK$uw%µA8UM';
